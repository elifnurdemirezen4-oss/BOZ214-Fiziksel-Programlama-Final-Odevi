...
### 3. `software/python_ble_gui` dizinine gidin ve arayüzü başlatın:
   ...
   ```
### 4.Arayüz açıldığında "Bluetooth ile Robota Bağlan" butonuna tıklayarak eşleşmeyi tamamlayın. Klavye üzerinden (W, A, S) kısayollarını kullanarak veya butonlarla robotu kontrol edebilirsiniz.
